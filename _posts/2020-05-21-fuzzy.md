...
Business Intelligence’ course. During this course, there were 2 projects to get simulated experience with common situations as a business analyst.

I played the role of a data analyst for a new online retailer, Maven
Fuzzy Factory, who produce stuffed animals. In this database, we have data
dealing with website sessions, website pageviews, products, orders,
order items, and refunds. The board of directors and executives need
answers to some questions to see if the business is growing efficiently.

The analysis was performed in MySQL Workbench and the reporting was done using R Markdown with the `RMariaDB` R Package and SQL chunks.
...
**Pull monthly trends by volume and Conversion Rate for ‘gsearch’ alongside each of our other channels**
...
**Estimate the additional orders we have recieved as a result from switching from ‘/home’ to ‘/lander-1’ as the landing page for ‘gsearch nonbrand’ sessions. (the lander-1 test period was from June 19 to July 28 of 2012)**

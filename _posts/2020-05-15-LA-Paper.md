...
![The LA model varies significantly from a traditional classroom.]({{ site.url }}{{ site.baseurl }}/images/TAvLA.png) 
...
![]({{ site.url }}{{ site.baseurl }}/images/unnamed-chunk-2-1.pdf)<!-- --> 
...
![]({{ site.url }}{{ site.baseurl }}/images/unnamed-chunk-4-1.pdf)<!-- --> 
...
## 
## data:  
## tab3$`DFW Rate`[tab3 == "Yes"] - tab3$`DFW Rate`[tab3$LA == "No"]
##
## W = 0.63002, p-value = 4.869e-05
```

![]({{ site.url }}{{ site.baseurl }}/images/unnamed-chunk-7-1.pdf)<!-- --> 
...
![]({{ site.url }}{{ site.baseurl }}/images/unnamed-chunk-9-1.pdf)<!-- --> 
